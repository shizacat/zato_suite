...
function create_config_zato {
	...
	echo "cluster_name=${CLUSTER_NAME}" >> ${ZATO_BASE}/zato_pattern.config
	echo "server_name=${SERVER_NAME}" >> ${ZATO_BASE}/zato_pattern.config
	echo "jwt_secret=${JWT_SECRET}" >> ${ZATO_BASE}/zato_pattern.config	
